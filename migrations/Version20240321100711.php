 ...
 */
final class Version20240321100711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD amount INT NOT NULL, ADD date DATE NOT NULL, ADD state VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP amount, DROP date, DROP state');
