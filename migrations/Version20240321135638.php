 ...
 */
final class Version20240321135638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP user_id, DROP amount, DROP date, DROP state');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD user_id INT DEFAULT NULL, ADD amount INT NOT NULL, ADD date DATE NOT NULL, ADD state VARCHAR(255) NOT NULL');
